...
export function Analytics() {
  ...
  const avgOrderValue = successfulPayments.length > 0 ? totalRevenue / successfulPayments.length : 0;
    ...
    <div className="p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600">Track your payment performance and revenue</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          ...
          <div className="flex items-center">
            ...
            <span className="text-sm text-purple-600">+5% from last period</span>
          </div>
        </div>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    {payment.txHash ? (
                      <span className="font-mono text-xs">
                        {payment.txHash.slice(0, 6)}...{payment.txHash.slice(-6)}
                      </span>
                    ) : (
                      '-'
                    )}
