...
import { ArrowLeft, Save, Eye, Palette, Type, Layout, Settings, Globe, Plus, Trash2 } from 'lucide-react';
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <button
              onClick={() => window.open(`/checkout/${currentPage.id || 'preview'}`, '_blank')}
      ...
      <div className="flex-1 flex">
        ...
        <div className="w-80 bg-white border-r border-gray-200 overflow-y-auto">
          <div className="p-4">
            ...
            {activeTab === 'design' && <DesignPanel currentPage={currentPage} setCurrentPage={setCurrentPage} />}
            {activeTab === 'content' && <ContentPanel currentPage={currentPage} setCurrentPage={setCurrentPage} />}
            {activeTab === 'fields' && <FieldsPanel currentPage={currentPage} setCurrentPage={setCurrentPage} />}
            {activeTab === 'settings' && <SettingsPanel currentPage={currentPage} setCurrentPage={setCurrentPage} />}
          </div>
        </div>
...
function DesignPanel({ currentPage, setCurrentPage }: { currentPage: CheckoutPage; setCurrentPage: (page: CheckoutPage) => void }) {
  return (
    <div className="space-y-6">
      <div>
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            { id: 'centered', name: 'Centered', desc: 'Classic centered layout' },
            ...
            <button
              key={layout.id}
              onClick={() => setCurrentPage({ ...currentPage, layout: layout.id as any })}
      ...
      <div>
        ...
        <div className="space-y-2">
          {['light', 'dark', 'custom'].map(theme => (
            <button
              key={theme}
              onClick={() => setCurrentPage({ ...currentPage, theme: theme as any })}
        ...
        <div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={color.key}>
                <label className="block text-sm text-gray-700 mb-1">{color.label}</label>
                <div className="flex items-center space-x-2">
                  <input
                    type="color"
                    value={currentPage.customColors?.[color.key as keyof typeof currentPage.customColors] || '#000000'}
        ...
        <div className="space-y-3">
          <div>
            ...
            <select
              ...
              onChange={(e) => setCurrentPage({
                ...currentPage,
                typography: { ...currentPage.typography, headingFont: e.target.value }
              })}
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => setCurrentPage({
                ...currentPage,
                typography: { ...currentPage.typography, bodyFont: e.target.value }
              })}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
            >
              <option value="Inter">Inter</option>
        ...
        <div className="space-y-3">
          <div>
            ...
            <input
              ...
              onChange={(e) => setCurrentPage({ ...currentPage, logo: e.target.value })}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
              placeholder="https://example.com/logo.png"
            />
          </div>
          <div>
            <label className="block text-sm text-gray-700 mb-1">Banner Image URL</label>
            <input
              type="url"
              value={currentPage.banner || ''}
              onChange={(e) => setCurrentPage({ ...currentPage, banner: e.target.value })}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
...
function ContentPanel({ currentPage, setCurrentPage }: { currentPage: CheckoutPage; setCurrentPage: (page: CheckoutPage) => void }) {
  const addFeature = () => {
  ...
  const addFaq = () => {
    const faq = [...(currentPage.content?.faq || []), { question: '', answer: '' }];
    setCurrentPage({
      ...currentPage,
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setCurrentPage({ ...currentPage, price: parseFloat(e.target.value) || 0 })}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
            />
          </div>
        </div>
      ...
      <div>
        ...
        <div className="space-y-3">
          <div>
            <label className="block text-sm text-gray-700 mb-1">Main Headline</label>
            <input
              type="text"
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => setCurrentPage({
                ...currentPage,
                content: { ...currentPage.content, subheadline: e.target.value }
              })}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
              rows={2}
      ...
      <div>
        ...
        <div className="space-y-3">
          <div>
            <label className="block text-sm text-gray-700 mb-1">Testimonial Text</label>
            <textarea
              ...
              onChange={(e) => setCurrentPage({
                ...
                content: {
                  ...currentPage.content,
                  testimonial: { ...currentPage.content?.testimonial, text: e.target.value }
                }
              })}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
              rows={3}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                onChange={(e) => setCurrentPage({
                  ...
                  content: {
                    ...currentPage.content,
                    testimonial: { ...currentPage.content?.testimonial, author: e.target.value }
                  }
                })}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
            ...
            <div>
              <label className="block text-sm text-gray-700 mb-1">Role/Title</label>
              <input
                type="text"
                ...
                onChange={(e) => setCurrentPage({
                  ...
                  content: {
                    ...currentPage.content,
                    testimonial: { ...currentPage.content?.testimonial, role: e.target.value }
                  }
                })}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
...
function FieldsPanel({ currentPage, setCurrentPage }: { currentPage: CheckoutPage; setCurrentPage: (page: CheckoutPage) => void }) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-sm font-medium text-gray-900 mb-3">Built-in Fields</h3>
        <div className="space-y-3">
          <label className="flex items-center">
            <input
              type="checkbox"
              checked={currentPage.collectEmail}
              onChange={(e) => setCurrentPage({ ...currentPage, collectEmail: e.target.checked })}
              className="rounded border-gray-300 text-teal-600 focus:ring-teal-500"
            />
            <span className="ml-2 text-sm text-gray-700">Collect email address</span>
          </label>
          <label className="flex items-center">
            <input
              type="checkbox"
              checked={currentPage.collectNotes}
              onChange={(e) => setCurrentPage({ ...currentPage, collectNotes: e.target.checked })}
              className="rounded border-gray-300 text-teal-600 focus:ring-teal-500"
            />
            <span className="ml-2 text-sm text-gray-700">Allow customer notes</span>
          </label>
          <label className="flex items-center">
            <input
              type="checkbox"
              checked={currentPage.collectShipping}
              onChange={(e) => setCurrentPage({ ...currentPage, collectShipping: e.target.checked })}
              className="rounded border-gray-300 text-teal-600 focus:ring-teal-500"
            />
...
function SettingsPanel({ currentPage, setCurrentPage }: { currentPage: CheckoutPage; setCurrentPage: (page: CheckoutPage) => void }) {
  return (
    <div className="space-y-6">
      <div>
        ...
        <div className="space-y-3">
          <div>
            <label className="block text-sm text-gray-700 mb-1">Payout Chain</label>
            <select
              value={currentPage.payoutChain}
              onChange={(e) => setCurrentPage({ ...currentPage, payoutChain: e.target.value })}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
            >
          ...
          <div>
            <label className="block text-sm text-gray-700 mb-1">Wallet Address</label>
            <input
              type="text"
              value={currentPage.walletAddress}
              onChange={(e) => setCurrentPage({ ...currentPage, walletAddress: e.target.value })}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
              placeholder="0x..."
            />
          </div>
      ...
      <div>
        ...
        <div className="space-y-3">
          ...
          <div>
            <label className="block text-sm text-gray-700 mb-1">Social Share Image URL</label>
            <input
              type="url"
